...
{
	public static OperationAsyncParam<TResult> CreateWithResult<TResult>(
	...
	public static OperationAsyncParam<TResult> CreateWithResult<TResult, T1>(
	...
	public static OperationAsyncParam<TResult> CreateWithResult<TResult, T1, T2>(
	...
	public static OperationAsyncParam<TResult> CreateWithResult<TResult, T1, T2, T3>(
	...
	{
		return new Generic.DoOperationAsyncWithResultAutoCompletionParam<TResult>(operation);
	}
	...
	public static OperationAsyncParam<TResult> CreateWithResult<TResult, T1>(
		...
		T1 value1)
	{
		return new Generic.DoOperationAsyncWithResultAutoCompletionParam<TResult, T1>(operation, value1);
	}
	...
	public static OperationAsyncParam<TResult> CreateWithResult<TResult, T1, T2>(
		...
		T2 value2)
	{
		return new Generic.DoOperationAsyncWithResultAutoCompletionParam<TResult, T1, T2>(operation, value1, value2);
	}
	...
	public static OperationAsyncParam<TResult> CreateWithResult<TResult, T1, T2, T3>(
		...
		T3 value3)
	{
		return new Generic.DoOperationAsyncWithResultAutoCompletionParam<TResult, T1, T2, T3>(operation, value1, value2, value3);
	}
}
